...
import { getFilmDetailFromApi, getImageFromApi } from '../API/TMBApi'
    ...
    if (film != undefined) {
      return (
        <ScrollView style={styles.scrollview_container}>
          ...
          <Text style={styles.default_text}>Genre(s) : {film.genres.map(function(genre){        // Map sert a parcourir les données (like foreach)
              return genre.name;
            }).join(" / ")}
          </Text>
